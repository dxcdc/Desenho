...
No repositório `fvier/receitas`, as tarefas principais e melhorias futuras são cadastradas automaticamente no GitHub via o workflow `.github/workflows/automatizar_issues.yml`.
